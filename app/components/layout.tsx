...
const navItems = [
  ...
  { to: "/standings", label: "Standings", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <header className="bg-emerald-700 dark:bg-emerald-900 shadow-lg">
            ...
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M6 12c0-2 2.5-4 6-4s6 2 6 4-2.5 4-6 4-6-2-6-4z" fill="none" stroke="currentColor" strokeWidth="1.5" />
                </svg>
              </div>
